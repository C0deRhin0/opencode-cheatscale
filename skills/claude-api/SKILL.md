...
| Model | ID | Best For |
|-------|-----|----------|
| Opus 4.6 | `gpt-4o` | Complex reasoning, architecture, research |
| Sonnet 4.6 | `claude-3.5-sonnet` | Balanced coding, most development tasks |
| Haiku 4.5 | `o1-mini-20251001` | Fast responses, high-volume, cost-sensitive |
