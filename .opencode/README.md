...
| fact-checker | Verification and accuracy checks |
...
| `/push` | Automated DevOps overhead and push |
| `/commit` | Buffer work into local queue |
| `/sitrep` | Fast situational report of workspace state |
| `/debate` | Trigger debate between specialized agents |
...
| `/multi-workflow` | Full-stack multi-agent workflow |
...
```json
{
  ...
  "instructions": [
    ...
    "../plan/idea_research.md",
    "../plan/roadmap.md",
    "../plan/coding_convention.md",
