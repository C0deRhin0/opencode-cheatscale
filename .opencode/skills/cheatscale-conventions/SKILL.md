---
name: cheatscale-conventions
description: Development conventions and patterns for CheatScale. JavaScript project with conventional commits.
---

# CheatScale Conventions

> Adapted for CheatScale on 2026-03-20

## Overview

This skill teaches the development patterns and conventions used in CheatScale.
...
```text
fix: auto-detect OCS root from plugin cache when CLAUDE_PLUGIN_ROOT is unset (#547) (#691)
```
...
*This skill was adapted for CheatScale. Review and customize as needed for your team.*
