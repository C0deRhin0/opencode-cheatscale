...
Analyze your OpenCode CheatScale setup's context window consumption and produce actionable recommendations to reduce token overhead.
...
2. Assume a 200K context window unless the user specifies otherwise
