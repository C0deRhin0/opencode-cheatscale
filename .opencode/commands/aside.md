...
- You're curious about something while OpenCode CheatScale is working and don't want to lose momentum
- You need a quick explanation of code currently being edited
- You want a second opinion or clarification on a decision without derailing the task
- You need to understand an error, concept, or pattern before work proceeds
